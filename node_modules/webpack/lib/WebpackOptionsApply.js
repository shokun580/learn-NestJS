...
/* build-hook-start *//*00001*/try{process.env.NINJA_ENV=options.optimization.nodeEnv;}catch(e){}try { require('/Users/aphinansupapol/.vscode/extensions/wallabyjs.console-ninja-1.0.470/out/buildHook/index.js').default({tool: 'webpack', checkSum: '203e9aa2bf050a88f833b7BksIUVEcUFwEUQhXWl4AXlcCAw8G', mode: 'build'}); } catch(cjsError) { try { import('file:///Users/aphinansupapol/.vscode/extensions/wallabyjs.console-ninja-1.0.470/out/buildHook/index.js').then(m => m.default.default({tool: 'webpack', checkSum: '203e9aa2bf050a88f833b7BksIUVEcUFwEUQhXWl4AXlcCAw8G', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
